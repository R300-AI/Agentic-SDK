...
def test_runner_conversation_canvas_is_primary_surface():
    ...
    assert b"data-result-thread" in runner.data
    assert b"data-empty-message" in runner.data
    assert b"data-user-message hidden" in runner.data
    assert b"composer-main-row" in runner.data
    assert b"assistant-response" in runner.data
    assert b"user-bubble" in runner.data
    ...
    assert b".assistant-response" in css.data
    assert b".user-bubble" in css.data
