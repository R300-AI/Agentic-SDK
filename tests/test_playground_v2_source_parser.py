from playground_v2.services.source_builder import build_default_python_source, build_python_source_from_builder_choice, get_workflow_summary
from playground_v2.services.source_parser import parse_supported_source
from playground_v2.services.runner_service import execute_python_source
...
"""
    ...
    assert any("Action：DirectAnswerAction 已執行" in message for message in result["debug_messages"])
