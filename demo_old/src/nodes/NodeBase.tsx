...
export function NodeBase({
  ...
  const tgtLabel = computeTarget ? COMPUTE_TARGET_OPTIONS.find((o) => o.value === computeTarget)?.label : undefined;
  return (
    <div className={`node-shell ${STATUS_CLASS[status]}`}>
      ...
      <div className="node-head">
        ...
        {tgtLabel && <span className={`node-badge badge-${computeTarget}`}>{tgtLabel}</span>}
      </div>
